...
function processStudents(students) {
    ...
    const filteredStudents = students.filter(student => student.marks > passingThreshold);
...
const result = processStudents(inputStudents);

console.log("Filtered and Sorted Student Names:", result);